"""
LoveDA ile DecoupleNet Eğitim Config - RTX 3080 Optimized
RTX 3080 10GB/12GB için optimize edilmiş parametreler

Kullanım: python train_supervision.py -c config/loveda/train_decouplenet_rtx3080.py
"""
...
# ===================== RTX 3080 OPTİMİZE PARAMETRELER =====================
max_epoch = 30
ignore_index = len(CLASSES)
train_batch_size = 4               # RTX 3080 10GB için güvenli değer
val_batch_size = 4
lr = 4e-4
weight_decay = 0.01
backbone_lr = 4e-4
...
weights_name = "decouplenet-loveda-rtx3080-epoch30"
weights_path = "model_weights/loveda"
test_weights_name = "last"
log_name = 'loveda/decouplenet-rtx3080'
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
...
# ===================== VERİ SETLERİ =====================
# Path'leri kendi sisteminize göre güncelleyin
...
# RTX 3080 için DataLoader ayarları
